  ...
  inputs =
    let
      vars = {
        version = "1.11.2";
        system = "x86_64-linux";
        devenv_root = "/home/domen/dev/nix-bindings-rust";
        project_input_ref = "path:/home/domen/dev/nix-bindings-rust";
        devenv_dotfile = "/home/domen/dev/nix-bindings-rust/.devenv";
        devenv_dotfile_path = ./.devenv;
        devenv_tmpdir = "/run/user/1000";
        devenv_runtime = "/run/user/1000/devenv-4dd9915";
        ...
        hostname = "cherimoya";
        username = "domen";
        git_root = "/home/domen/dev/nix-bindings-rust";
        secretspec = null;
      };
    in
    {
