...
//! process.
//!
//! Nix's C logger API can install observers, but it cannot create activities.
//! This crate provides that missing emitting side through a small CXX bridge to
...
mod tests {
    ...
    #[test]
    fn emits_message() {
        log(LogLevel::Debug, "nix-bindings-logger message smoke test");
    }
